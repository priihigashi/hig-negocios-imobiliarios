...
window.LISTINGS = {
  ...
  'urbanova-paratehy': {
    ...
    photos: [
      ...
      { src: 'images/listings/urbanova-paratehy/10_varanda.jpg',           caption: 'Varanda' },
      ...
      { src: 'images/listings/urbanova-paratehy/19_transicao_piscina.jpg', caption: 'Área de Lazer' },
      { src: 'images/listings/urbanova-paratehy/09_piscina.jpg',           caption: 'Piscina' },
      { src: 'images/listings/urbanova-paratehy/15_piscina_noturna.jpg',   caption: 'Piscina · Iluminação' },
  ...
  'eco-park-cacapava': {
    ...
    photos: [
      ...
      { src: 'images/listings/eco-park-cacapava/12_interior_a.jpg', caption: 'Interior · Entrada' },
      { src: 'images/listings/eco-park-cacapava/13_interior_b.jpg', caption: 'Interior' },
      { src: 'images/listings/eco-park-cacapava/14_interior_c.jpg', caption: 'Interior · Sala' },
      { src: 'images/listings/eco-park-cacapava/15_interior_d.jpg', caption: 'Interior · Cozinha' },
      { src: 'images/listings/eco-park-cacapava/16_interior_8573.jpg', caption: 'Área de Lazer' },
      { src: 'images/listings/eco-park-cacapava/17_interior_8576.jpg', caption: 'Área Externa' },
      { src: 'images/listings/eco-park-cacapava/04_video_8572.jpg', caption: 'Piscina' },
      { src: 'images/listings/eco-park-cacapava/05_video_8573.jpg', caption: 'Área Gourmet' },
